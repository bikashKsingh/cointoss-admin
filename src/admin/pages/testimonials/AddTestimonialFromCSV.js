...
import { testimonial } from "../../helpers/csvHelper";

const AddTestimonialFromCSV = () => {
  ...
  return (
    <div className="page-wrapper">
      <div className="container-fluid">
        ...
        {/* <!-- ============================================================== --> */}
        <Breadcrumb title={"TESTIMONIALS"} pageTitle={"Add User"} />
                ...
                <div className="col-md-12 d-flex justify-content-between">
                  ...
                  <div className="">
                    <CSVLink
                      ...
                      data={testimonial.dummyData}
                      headers={testimonial.headers}
                      filename="testimonial-users.csv"
                    >
                      Download CSV
                    </CSVLink>
                  </div>
...
export default AddTestimonialFromCSV;
