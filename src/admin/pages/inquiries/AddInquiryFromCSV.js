...
import { inquires } from "../../helpers/csvHelper";
  ...
  return (
    <div className="page-wrapper">
      <div className="container-fluid">
        ...
        <Breadcrumb title="INQUIRY" pageTitle={"Add Inquiry"} />
                ...
                <div className="col-md-12 d-flex justify-content-between">
                  ...
                  <div className="">
                    <CSVLink
                      ...
                      data={inquires.dummyData}
                      headers={inquires.headers}
                      filename="inquires.csv"
                    >
                      Download CSV
                    </CSVLink>
                  </div>
