...
const InquiryList = (props) => {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/inquires/${deleteId}`, {
      method: "DELETE",
  ...
  useEffect(() => {
    let url = `${Config.SERVER_URL}/inquires?page=${pagination.page}&limit=${pagination.limit}&status=${status}&inquiryStatus=${inquiryStatus}`;
          ...
          return (
            <>
              <Link
                ...
                to={{
                  pathname: `/admin/inquiry/edit/${value}`,
                }}
              >
  ...
  return (
    <div className="page-wrapper px-0 pt-0">
      <div className={"container-fluid"}>
        ...
        <Breadcrumb title={"INQUIRES"} pageTitle={"Inquires List"} />
                ...
                <div className="row">
                  <div className="d-flex col-md-6">
                    ...
                    <div className="border px-2 ml-2">
                      <select
                        ...
                        value={inquiryStatus}
                        onChange={(evt) => {
                          setInquiryStatus(evt.target.value);
                        }}
                      >
                  ...
                  <div className="col-md-6 text-right">
                    <Link
                      ...
                      to={{
                        pathname: "/admin/inquiry/addByCSV",
                      }}
                    >
                    ...
                    <Link
                      className="btn btn-info rounded mr-2"
                      to={{
                        pathname: "/admin/inquiry/editByCSV",
                      }}
                    >
                      <span className={"fas fa-edit"}></span> Update By CSV
                    </Link>

                    <Link to={"/admin/inquiry/add"} className={"btn btn-info "}>
