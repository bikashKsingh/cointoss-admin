...
const MainMenuList = (props) => {
  ...
  useEffect(() => {
    let url = `${Config.SERVER_URL}/mainMenus?page=${pagination.page}&limit=${pagination.limit}&status=${status}`;
          ...
          return (
            <>
              <Link
                ...
                to={{
                  pathname: `/admin/mainMenu/edit/${value}`,
                }}
              >
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 text-right">
                    {/* <Link
                      ...
                      to={{
                        pathname: "/admin/mainMenu/addByCSV",
                      }}
                    >
                    ...
                    {/* <Link
                      className="btn btn-info rounded mr-2"
                      to={{
                        pathname: "/admin/mainMenu/editByCSV",
                      }}
                    >
                    ...
                    <Link
                      to={"/admin/mainMenu/add"}
                      className={"btn btn-info "}
                    >
                      <span className={"fas fa-plus"}></span> Item
                    </Link>
                  </div>
                </div>
              </div>
