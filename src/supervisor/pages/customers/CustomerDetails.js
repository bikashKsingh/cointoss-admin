...
const CustomerDetails = () => {
  ...
  useEffect(() => {
    fetch(`${Config.SERVER_URL}/supervisorCustomers/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
  ...
  useEffect(() => {
    setUserLoaded(false);
    fetch(`${Config.SERVER_URL}/supervisorSubscriptions?customer=${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_supervisor_token")}`,
  ...
  useEffect(() => {
    fetch(
      `${Config.SERVER_URL}/supervisorSubscriptionHistories?customer=${id}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
  ...
  useEffect(() => {
    setUserLoaded(false);
    fetch(`${Config.SERVER_URL}/supervisorOrders?customer=${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_supervisor_token")}`,
  ...
  useEffect(() => {
    fetch(`${Config.SERVER_URL}/supervisorOrderHistories?customer=${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: `Bearer ${localStorage.getItem("jwt_supervisor_token")}`,
                                        ...
                                        {subscriptions.map((data, index) => {
                                          return (
                                            <tr key={index}>
                                              ...
                                              <td>
                                                <Link
                                                  to={`/supervisor/bucket/details/${data?.bucketDetails?.bucket?._id}`}
                                                >
                                                  {
                                                    data?.bucketDetails
                                                      ?.bucketName
                                              ...
                                              <td>
                                                <Link
                                                  class="btn btn-info"
                                                  to={`/supervisor/subscription/details/${data._id}`}
                                                >
                                                  View
                                                </Link>
                                              </td>
                                            ...
                                            return (
                                              <tr key={index}>
                                                ...
                                                <td>
                                                  <Link
                                                    class="btn btn-info"
                                                    to={`/supervisor/subscriptionHistory/details/${data._id}`}
                                                  >
                                                    View
                                                  </Link>
                                                </td>
                                          ...
                                          return (
                                            <tr key={index}>
                                              ...
                                              <td>
                                                <Link
                                                  class="btn btn-info"
                                                  to={`/supervisor/order/details/${data._id}`}
                                                >
                                                  View
                                                </Link>
                                              </td>
                                        ...
                                        {orderHistories.map((data, index) => {
                                          return (
                                            <tr key={index}>
                                              ...
                                              <td>
                                                <Link
                                                  to={`/supervisor/order/details/${data?.order?._id}`}
                                                >
                                                  {data?.order?._id}
                                                </Link>
                                              </td>
