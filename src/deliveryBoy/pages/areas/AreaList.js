...
const AreaList = (props) => {
  ...
  useEffect(() => {
    setIsAllAreasLoaded(false);
    let url = `${Config.SERVER_URL}/deliveryBoys/profile`;
      ...
      .then(
        (result) => {
          ...
          if (result.status === 200) {
            setAllData(result.body.deliveryAreas || []);
          } else {
  ...
  // Count Records
  // useEffect(() => {
  //   let url = `${Config.SERVER_URL}/areas?skip=0&limit=0&status=${status}`;
  ...
  return (
    <div className="page-wrapper px-0 pt-0">
      <div className={"container-fluid"}>
        ...
        <Breadcrumb title={"DELIVERY AREA"} pageTitle={"Delivery List"} />
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/admin/area/edit/${data.id}`,
                                    }}
                                  >
                                    <span
