...
const OrderList = (props) => {
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/deliverBoyOrders/${deleteId}`, {
      method: "DELETE",
  ...
  useEffect(() => {
    ...
    let url = `${Config.SERVER_URL}/deliveryBoyOrders?skip=${pagination.skip}&limit=${pagination.limit}`;
    if (filterFormDtata.orderStatus !== "ALL") {
      url = url + `&orderStatus=${filterFormDtata.orderStatus}`;
    }
  ...
  // Count Records
  useEffect(() => {
    let url = `${Config.SERVER_URL}/deliveryBoyOrders?skip=0&limit=100000`;
    if (orderStatus !== "ALL") {
                  ...
                  <div className="form-inline d-flex" style={{ gap: "10px" }}>
                    <select
                      ...
                      onChange={(evt) => {
                        ...
                        history.push(
                          "/supervisor/orders?orderStatus=" + evt.target.value
                        );
                      }}
                      value={filterFormDtata.orderStatus}
                    >
