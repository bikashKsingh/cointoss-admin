...
const DeliveryReports = (props) => {
  ...
  useEffect(() => {
    ...
    let url = `${Config.SERVER_URL}/deliveryBoyDeliveryDetails/?skip=${pagination.skip}&limit=${pagination.limit}`;
  ...
  // Count Records
  useEffect(() => {
    let url = `${Config.SERVER_URL}/deliveryBoyDeliveryDetails?skip=0&limit=20000`;
    if (subscriptionStatus !== "ALL") {
      url = url + `&subscriptionStatus=${subscriptionStatus}`;
    }
    if (filterFormDtata.deliveryDate)
  ...
  return (
    <div className="page-wrapper px-0 pt-0">
      <div className={"container-fluid"}>
        ...
        <Breadcrumb title={"DELIVERY REPORTS"} pageTitle={"Report List"} />
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div className="form-inline d-flex" style={{ gap: "10px" }}>
                    <select
                      ...
                      onChange={(evt) => {
                        setFilterFormDtata(evt.target.value);
                        history.push(
